...
<div class="row">
  <div class="col-md-12">
    <div class="x_panel">
      <div id="data_pasien" align="center">
        <?php $this->load->view('tagihan/tb_pasien',array('IOL'=>'O')); ?>
        <!--<i class="red">Silakan cari pasien dahulu!</i>--></div>
    </div>
  </div>
</div>
<script type="text/javascript">
 ...
 function cari() 
 {
   tunggu_start();
   $.ajax({
         url : "<?php echo base_url('index.php/tagihan/tagihan_hd/cari_pasien'); ?>",
         type : "post",
