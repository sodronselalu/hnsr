          ...
          <div class="form-horizontal form-label-left">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-9 col-xs-12">
                <select class="form-control" id="KD_JENIS" name="KD_JENIS" onchange="cari(); cek_unit(this.value);">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-9 col-xs-12">
                <select class="form-control selectpicker" id="KD_UNIT" name="KD_UNIT" onchange="cari()" data-live-search="true">
...
<div class="row">
  <div class="col-md-12">
    <div class="x_panel">
      <div id="data_pasien" align="center"><?php $this->load->view('layanan/tb_pasien_assesment',array('IOL'=>'O','KD_UNIT'=>'RPHD')); ?></div>
    </div>
  </div>
</div>
<script type="text/javascript">
 ...
 function cari()
 {
   tunggu_start();
   $.ajax({
         url : "<?php echo base_url('index.php/layanan/assesment_hd/cari_pasien'); ?>",
         type : "post",
 ...
 {
   $.ajax({
         url : "<?php echo base_url('index.php/layanan/assesment_hd/cari_unit'); ?>",
         type : "post",
         data : {
            IOL : i,
         },
