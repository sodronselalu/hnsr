...
<div class="row">
  <div class="col-md-12">
    <div class="x_panel">
      <div id="data_pasien" align="center"><?php $this->load->view('layanan/tb_pasien',array('IOL'=>'O','KD_UNIT'=>'RPHD')); ?></div>
    </div>
  </div>
</div>
<script type="text/javascript">
 ...
 {
   $.ajax({
         url : "<?php echo base_url('index.php/layanan/pelayanan_hd/cari_unit'); ?>",
         type : "post",
         data : {
            IOL : i,
         },
