  ...
  <tr>
    <td>
      <table cellpadding="0.5px">
        ...
        <tr>
          <td align="left" width="30px">No Reg</td>
          <td align="left" width="80px">: <?php echo $tg->NO_REG; ?></td>
        </tr>
        <tr>
          <td align="left" width="30px">No CM</td>
          <td align="left" width="80px">: <?php echo $tg->NO_CM; ?></td>
        </tr>
      </table>
    </td>
    <td>
      <table cellpadding="0.5px">
        ...
        <tr>
          <td align="left" width="40px">Asuransi</td>
          <td align="left" width="170px">: <?php echo $tg->NM_ASURANSI; ?></td>
        </tr>
        <tr>
          <td align="left" width="40px">Dokter</td>
          <td align="left" width="170px">: <?php echo $tg->NM_DOKTER; ?></td>
        </tr>
      </table>
    </td>
  </tr>
